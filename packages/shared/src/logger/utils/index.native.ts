...
import {
  FileLogger,
  LogLevel,
} from '@unionkeyhq/shared/src/modules3rdParty/react-native-file-logger';
import RNFS from '@unionkeyhq/shared/src/modules3rdParty/react-native-fs';
import { zip } from '@unionkeyhq/shared/src/modules3rdParty/react-native-zip-archive';
...
const NATIVE_LOG_ZIP_PATH = `${RNFS?.CachesDirectoryPath || 'UnionKey'}/logs_zip`;
