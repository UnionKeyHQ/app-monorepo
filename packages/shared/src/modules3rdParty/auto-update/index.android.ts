...
export const downloadASC: IDownloadASC = async ({
  ...
  // });
  console.log('downloadASC called - automatically success', { downloadUrl, latestVersion });
  // 模拟异步等待
...
export const verifyASC: IVerifyASC = async ({ downloadUrl, latestVersion }) => {
  ...
  //   filePath: buildFilePath(latestVersion),
  // });
  console.log('verifyASC called - automatically success', { downloadUrl, latestVersion });
  // 模拟异步等待
  await new Promise(res => setTimeout(res, 100));
  return;
};
...
export const verifyPackage: IVerifyPackage = async (params) => {
  ...
  // });
  console.log('verifyPackage called - automatically success', params);
...
export const installPackage: IInstallPackage = async ({
  ...
  console.log('Mock installPackage called', { latestVersion, downloadUrl });
