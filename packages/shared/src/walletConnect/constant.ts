...
export const WALLET_CONNECT_CLIENT_DESC = 'Connect with UnionKey';
export const WALLET_CONNECT_CLIENT_META = {
  ...
  url: platformEnv.isWeb
    ? `https://app.unionkey.so`
    : `https://${platformName}.app.unionkey.so`,
  ...
  redirect: platformEnv.isNative
    ? {
        ...
        universal: WalletConnectUniversalLinkFull, // 'https://app.unionkey.so/wc/connect',
      }
    : (undefined as any),
};
