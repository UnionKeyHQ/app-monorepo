...
export const UNIONKEY_APP_DEEP_LINK = `${UNIONKEY_APP_DEEP_LINK_NAME}://`; // unionkey:// will open unionkey legacy
export const WALLET_CONNECT_DEEP_LINK_NAME = 'wc';
export const WALLET_CONNECT_DEEP_LINK = `${WALLET_CONNECT_DEEP_LINK_NAME}://`;

export enum EUnionKeyDeepLinkPath {
  url_account = 'url_account',
  market_detail = 'market_detail',
  invite_share = 'invite_share',
}
export type IEUnionKeyDeepLinkParams = {
  [EUnionKeyDeepLinkPath.url_account]: {
    networkCode: string;
    address: string;
  };
  [EUnionKeyDeepLinkPath.market_detail]: {
    coinGeckoId: string;
  };
  [EUnionKeyDeepLinkPath.invite_share]: {
    utm_source: string;
    code: string;
  };
};
...
export const UNIONKEY_UNIVERSAL_LINK_HOST = 'app.unionkey.so';
export const UNIONKEY_UNIVERSAL_TEST_LINK_HOST = 'app.unionkeytest.com';
...
export const WalletConnectUniversalLinkFull = `https://${UNIONKEY_UNIVERSAL_LINK_HOST}/wc/connect`;
