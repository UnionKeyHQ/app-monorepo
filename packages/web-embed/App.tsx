...
// import { Provider } from '@unionkeyhq/kit';
...
import { Box, Provider } from '@unionkeyhq/components';
import type { LocaleSymbol } from '@unionkeyhq/components/src/locale';
import LOCALES from '@unionkeyhq/components/src/locale';
import { wait } from '@unionkeyhq/kit/src/utils/helper';
import { ONBOARDING_WEBVIEW_METHODS } from '@unionkeyhq/kit/src/views/Onboarding/screens/CreateWallet/BehindTheScene/consts';
import type { IProcessAutoTypingRef } from '@unionkeyhq/kit/src/views/Onboarding/screens/CreateWallet/BehindTheScene/ProcessAutoTyping';
import ProcessAutoTyping from '@unionkeyhq/kit/src/views/Onboarding/screens/CreateWallet/BehindTheScene/ProcessAutoTyping';
