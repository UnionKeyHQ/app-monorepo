  ...
  constructor(update = false) {
    Realm.open({
      ...
      .then((realm) => {
        ...
        //   // const { PortalEntry } =
        //   //   require('@unionkeyhq/kit/src/views/Overlay/RootPortal') as typeof import('@unionkeyhq/kit/src/views/Overlay/RootPortal');
        //   // const { FULLWINDOW_OVERLAY_PORTAL } =
        //   //   require('@unionkeyhq/kit/src/utils/overlayUtils') as typeof import('@unionkeyhq/kit/src/utils/overlayUtils');
