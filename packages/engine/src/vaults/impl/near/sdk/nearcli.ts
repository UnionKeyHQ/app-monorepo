...
import { SimpleClient } from '@unionkeyhq/engine/src/client/BaseClient';
import type { CoinInfo } from '@unionkeyhq/engine/src/types/chain';
...
import { JsonPRCResponseError } from '@unionkeyhq/shared/src/errors/request-errors';
