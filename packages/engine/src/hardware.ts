...
import type { IPrepareHardwareAccountsParams } from '@unionkeyhq/engine/src/vaults/types';
import { isHexString } from '@unionkeyhq/kit/src/utils/helper';
import { convertDeviceError } from '@unionkeyhq/shared/src/device/deviceErrorUtils';
