...
import type { ExplorerShortcutEvents } from '@unionkeyhq/shared/src/shortcuts/shortcuts.enum';
import { getShortcutsMap } from '@unionkeyhq/shared/src/shortcuts/shortcuts.enum';
