import { Anchor, SizableText, Stack, YStack } from '@unionkey/components';
    ...
    elements={[
      {
        ...
        element: (
          <YStack gap="$4" alignItems="flex-start">
            ...
            <Anchor href="https://github.com/unionkey">UnionKey GitHub</Anchor>
          </YStack>
        ),
      },
      {
      ...
      },
      {
        ...
        element: (
          <Stack gap="$2">
            ...
            <SizableText>
              Check out our{' '}
              <Anchor href="https://github.com/unionkey">
                GitHub repository
              </Anchor>{' '}
              to see our code.
            </SizableText>
