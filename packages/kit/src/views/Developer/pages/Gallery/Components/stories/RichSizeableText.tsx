import { SizableText, Stack, YStack } from '@unionkeyhq/components';
import { RichSizeableText } from '@unionkeyhq/components/src/content/RichSizeableText';
        ...
        element: (
          <Stack>
            <RichSizeableText
              linkList={{
                terms: {
                  url: 'https://unionkey.io/school/unionkey-usage-guide/deposit-terms.html',
                  onPress: () => {
                    console.log('Terms link pressed');
                  },
                },
                privacy: {
                  url: 'https://unionkey.io/school/unionkey-usage-guide/Privacy-Policy.html',
                  onPress: () => {
