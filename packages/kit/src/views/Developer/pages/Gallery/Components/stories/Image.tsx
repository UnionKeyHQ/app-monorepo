import { Icon, Image, Skeleton, YStack } from '@unionkeyhq/components';
    ...
    elements={[
        ...
        element: (
          <YStack gap={10}>
            <Image
              height="$10"
              width="$10"
              source={require('@unionkeyhq/kit/assets/walletLogo/cosmos_keplr.png')}
            />
            <Image
              height="$10"
              width="$10"
              source={{
                uri: 'https://uni.unionkey.io/static/chain/btc.png',
              }}
            />
          </YStack>
        ),
        ...
        element: (
          <YStack gap="$4">
            ...
            >
              <Image.Source
                source={{
                  uri: 'https://dev.unionkey.io/dashboard/dapp/upload_1706684476225.0.17899416707349025.0.jpeg',
                }}
              />
              <Image.Fallback>
                <Icon
      ...
      },
      {
        ...
        element: (
          <YStack gap="$4">
            <Image height="$10" width="$10">
              <Image.Source src="https://uni.unionkey.io/static/chain/btc.pn" />
              <Image.Skeleton />
            </Image>
            <Image
              size="$14"
            ...
            >
              <Image.Source
                source={{
                  uri: 'https://uni.unionkey.io/static/chain/btc.pn',
                }}
              />
              <Image.Fallback>
                <Icon
