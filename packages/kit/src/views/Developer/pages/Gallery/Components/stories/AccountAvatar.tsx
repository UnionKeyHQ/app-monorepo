...
import { Button, Select, YStack } from '@unionkey/components';
import type { IAccountAvatarProps } from '@unionkey/kit/src/components/AccountAvatar';
...
const invalidExternalAccount: IDBExternalAccount = {
  ...
  connectionInfo: {
    evmInjected: {
      global: 'ethereum',
      name: 'string',
      icon: 'https://uni.unionkey-asset.com/static/chain/btc.pn',
    },
  },
} as IDBExternalAccount;
    ...
    elements={[
      {
        ...
        element: (
          <YStack gap="$4" justifyContent="center">
            ...
            <AccountAvatar
              size="small"
              src="https://uni.unionkey-asset.com/static/chain/btc.pn"
            />
            <AccountAvatar
              size="small"
              src="https://uni.unionkey-asset.com/static/chain/btc.png"
            />
            <AccountAvatar src="https://uni.unionkey-asset.com/static/chain/btc.png" />
          </YStack>
        ),
      },
      {
          ...
          return (
            <YStack gap="$4">
              ...
              <YStack gap="$4">
                <Button
                  onPress={() => {
                    setUri('https://uni.unionkey-asset.com/static/chain/btc.pn');
                  }}
                >
                ...
                <Button
                  onPress={() => {
                    setUri('https://uni.unionkey-asset.com/static/chain/btc.png');
                  }}
                >
                  Change to valid URI
                </Button>
