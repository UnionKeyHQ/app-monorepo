import { QRCode, YStack } from '@unionkeyhq/components';
    ...
    elements={[
      {
        ...
        element: (
          <YStack justifyContent="center" flex={1} gap="$4">
            <QRCode value="https://unionkey.io/" size={200} />
          </YStack>
        ),
      },
      {
      ...
      },
      {
        ...
        element: (
          <YStack justifyContent="center" flex={1} gap="$4">
            <QRCode
              logo={require('@unionkeyhq/kit/assets/logo.png')}
              value="https://unionkey.io/"
              size={200}
            />
            <QRCode
      ...
      },
      {
        ...
        element: (
          <YStack justifyContent="center" flex={1} gap="$4">
            <QRCode drawType="line" value="https://unionkey.io/" size={200} />
            <QRCode drawType="line" value="https://unionkey.io/" size={200} />
          </YStack>
        ),
      },
