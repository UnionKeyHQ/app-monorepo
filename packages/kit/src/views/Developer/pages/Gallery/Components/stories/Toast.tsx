...
import { Button, Toast, ToastContent, YStack } from '@unionkeyhq/components';
            ...
            <Button
              onPress={() => {
                Toast.success({
                  title: 'url!',
                  message:
                    'look, <url>https://unionkey.io<underline>here</underline></url>. UnionKey.',
                });
              }}
            >
              Toast with url
            ...
            <Button
              onPress={() => {
                Toast.warning({
                  duration: ONE_HOUR,
                  title:
                    'You can only transfer funds to accounts within the wallet or to allowlisted addresses in the address book. If you understand the risks, you can enable it in <url>https://unionkey.io/send/protection<underline>Settings >> Protection</underline></url>',
                });
              }}
            >
              Rich Text
