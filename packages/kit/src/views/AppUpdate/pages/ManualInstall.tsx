...
import { Image, Page, SizableText, YStack } from '@unionkeyhq/components';
import { useDownloadPackage } from '@unionkeyhq/kit/src/components/UpdateReminder/hooks';
  ...
  const image = useMemo(() => {
    ...
    if (platformEnv.isDesktopMac) {
      return (
        <Image
          h="$96"
          source={require('@unionkeyhq/kit/assets/manual_install_mac.png')}
        />
      );
    }
    return (
      <Image
        h="$100"
        mt="$5"
        source={require('@unionkeyhq/kit/assets/manual_install_win.png')}
      />
    );
  }, []);
  return (
