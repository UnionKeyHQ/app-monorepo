...
import { revokeUrl } from '@unionkeyhq/engine/src/managers/revoke';
import type { Account } from '@unionkeyhq/engine/src/types/account';
import type { Network } from '@unionkeyhq/engine/src/types/network';
import btcSetting from '@unionkeyhq/engine/src/vaults/impl/btc/settings';
import tbtcSetting from '@unionkeyhq/engine/src/vaults/impl/tbtc/settings';
import {
  HomeRoutes,
  InscribeModalRoutes,
  MainRoutes,
