...
import type { ForwardRefHandle } from '@unionkeyhq/app/src/views/NestedTabView/NestedTabView';
import { Box, useIsVerticalLayout, useUserDevice } from '@unionkeyhq/components';
