...
import RestartTouch from '@unionkeyhq/kit/assets/animations/restart-touch.json';
import SelectFirmwareResources from '@unionkeyhq/kit/assets/select_firmware_resources.png';
import SelectFirmwareResourcesDark from '@unionkeyhq/kit/assets/select_firmware_resources_dark.png';
import backgroundApiProxy from '@unionkeyhq/kit/src/background/instance/backgroundApiProxy';
import { useSettings } from '@unionkeyhq/kit/src/hooks/redux';
import type { HardwareUpdateRoutesParams } from '@unionkeyhq/kit/src/routes/Root/Modal/HardwareUpdate';
import { HardwareUpdateModalRoutes } from '@unionkeyhq/kit/src/routes/routesEnum';
