...
import MacSecurityPrivacyLightImage from '@unionkeyhq/kit/assets/mac_security_and_privacy.png';
import MacSecurityPrivacyDarkImage from '@unionkeyhq/kit/assets/mac_security_and_privacy_dark.png';
