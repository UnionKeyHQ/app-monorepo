      ...
      switch (stateInfo?.type) {
        ...
        case 'manually-enter-bootloader-one':
          ...
          if (stateInfo?.content?.deviceType === 'mini') {
            ...
            stateContent.sourceSrc = require('@unionkeyhq/kit/assets/animations/lottie-unionkey-mini-in-bootloader-mode-disconnect-your-device.json');
            ...
            // eslint-disable-next-line global-require
            stateContent.sourceSrc = require('@unionkeyhq/kit/assets/animations/lottie-unionkey-classic-in-bootloader-mode.json');
            stateContent.description = intl.formatMessage({
        ...
        case 'manually-enter-bootloader-two':
          ...
          if (stateInfo?.content?.deviceType === 'mini') {
            // eslint-disable-next-line global-require
            stateContent.sourceSrc = require('@unionkeyhq/kit/assets/animations/lottie-unionkey-mini-in-bootloader-mode.json');
            stateContent.description = intl.formatMessage({
