...
import UnionKeyMiniEnterPin from '@unionkeyhq/kit/assets/animations/lottie_hardware_unionkey_classic_enter_pin_code.json';
    ...
    <>
      ...
      {!type && (
        <Box flexDirection="column" alignItems="center" w="100%">
          <Box w="100%" h="220px">
            <LottieView source={UnionKeyMiniEnterPin} autoPlay loop />
          </Box>
