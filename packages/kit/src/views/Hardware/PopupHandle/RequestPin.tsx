...
import EnterPinCodeOnClassic from '@unionkeyhq/kit/assets/animations/enter-pin-on-classic.json';
import EnterPinCodeOnMini from '@unionkeyhq/kit/assets/animations/enter-pin-on-mini.json';
import EnterPinCodeOnPro from '@unionkeyhq/kit/assets/animations/enter-pin-on-pro-light.json';
import EnterPinCodeOnTouch from '@unionkeyhq/kit/assets/animations/enter-pin-on-touch.json';
import {
  AppUIEventBusNames,
  appUIEventBus,
