...
import { Box, CheckBox, Icon, LottieView, Text } from '@unionkeyhq/components';
import EnterPassphraseOnClassic from '@unionkeyhq/kit/assets/animations/enter-passphrase-on-classic.json';
import EnterPassphraseOnMini from '@unionkeyhq/kit/assets/animations/enter-passphrase-on-mini.json';
import EnterPassphraseOnPro from '@unionkeyhq/kit/assets/animations/enter-passphrase-on-pro-light.json';
import EnterPassphraseOnTouch from '@unionkeyhq/kit/assets/animations/enter-passphrase-on-touch.json';
import backgroundApiProxy from '@unionkeyhq/kit/src/background/instance/backgroundApiProxy';
import { SkipAppLock } from '@unionkeyhq/kit/src/components/AppLock';
