...
import { Modal, Spinner, ToastManager } from '@unionkeyhq/components';
import type { LocaleIds } from '@unionkeyhq/components/src/locale';
import backgroundApiProxy from '@unionkeyhq/kit/src/background/instance/backgroundApiProxy';
import Protected, {
  ValidationFields,
} from '@unionkeyhq/kit/src/components/Protected';
...
import { savePassword } from '@unionkeyhq/kit/src/utils/localAuthentication';
