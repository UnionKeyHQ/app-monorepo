...
import { Box, Form, Text, useIsVerticalLayout } from '@unionkeyhq/components';
import type { Token } from '@unionkeyhq/engine/src/types/token';
import type { IInvoiceConfig } from '@unionkeyhq/engine/src/vaults/impl/lightning-network/types/invoice';
import { FormatCurrencyTokenOfAccount } from '@unionkeyhq/kit/src/components/Format';
import { TxInteractInfo } from '@unionkeyhq/kit/src/views/TxDetail/components/TxInteractInfo';
