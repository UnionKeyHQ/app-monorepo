...
import LogoBlack from '@unionkeyhq/components/src/Icon/react/illus/LogoBlack';
import LogoWhite from '@unionkeyhq/components/src/Icon/react/illus/LogoWhite';
...
const getShareModule = async () => {
  ...
  return (
    await import('@unionkeyhq/shared/src/modules3rdParty/react-native-share')
  ).default;
};
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <QRCode
                    value="https://unionkey.io/mobile"
                    size={48}
                    logoSize={0}
                    logoMargin={0}
