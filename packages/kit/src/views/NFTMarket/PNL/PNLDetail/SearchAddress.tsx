...
import PnlEmptyImage from '@unionkeyhq/kit/assets/nft_pnl_empty_image.png';
import PnlEmptyImageLight from '@unionkeyhq/kit/assets/nft_pnl_empty_image_light.png';
import { ModalRoutes, RootRoutes } from '@unionkeyhq/kit/src/routes/routesEnum';
