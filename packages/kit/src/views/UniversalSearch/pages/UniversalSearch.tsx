...
import type { ITabHeaderInstance } from '@unionkeyhq/components/src/layouts/TabView/Header';
import { DiscoveryBrowserProviderMirror } from '@unionkeyhq/kit/src/views/Discovery/components/DiscoveryBrowserProviderMirror';
...
} from '@unionkeyhq/shared/src/routes/universalSearch';
import { EAccountSelectorSceneName } from '@unionkeyhq/shared/types';
import type { IUniversalSearchResultItem } from '@unionkeyhq/shared/types/search';
import {
  ESearchStatus,
  EUniversalSearchType,
} from '@unionkeyhq/shared/types/search';
