...
import type { ISettingsDevModeInfo } from '@unionkeyhq/kit/src/store/reducers/settings';
import {
  setDevMode,
  setEnablePerfCheck,
...
import timelinePerfTrace from '@unionkeyhq/shared/src/perf/timelinePerfTrace';
