...
import CardanoNamiLogo from '@unionkeyhq/kit/assets/walletLogo/cardano_nami.png';
import ConflusFluentLogo from '@unionkeyhq/kit/assets/walletLogo/conflux_fluent_wallet.png';
import CosmosKeplrLogo from '@unionkeyhq/kit/assets/walletLogo/cosmos_keplr.png';
import MetamaskLogo from '@unionkeyhq/kit/assets/walletLogo/evm_metamask.png';
import PolkadotJsLogo from '@unionkeyhq/kit/assets/walletLogo/polkadot_polkadot_js.png';
import SolanaPhantomLogo from '@unionkeyhq/kit/assets/walletLogo/solana_phantom.png';
import StarcoinStarmaskLogo from '@unionkeyhq/kit/assets/walletLogo/starcoin_starmask.png';
import SuiWalletLogo from '@unionkeyhq/kit/assets/walletLogo/sui_sui_wallet.png';
import TronLinkLogo from '@unionkeyhq/kit/assets/walletLogo/tron_tronlink.png';
