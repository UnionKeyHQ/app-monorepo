...
import { Anchor, SizableText, View } from '@unionkey/components';
...
export function TermsAndPrivacy() {
  const intl = useIntl();
  const termsLink = useHelpLink({ path: 'unionkey-usage-guide/deposit-terms.html' });
  const privacyLink = useHelpLink({ path: 'unionkey-usage-guide/Privacy-Policy.html' });
