...
import type {
  DeviceInfo,
  MigrateData,
} from '@unionkeyhq/engine/src/types/migrate';
import { MigrateErrorCode } from '@unionkeyhq/engine/src/types/migrate';
import { httpServerEnable } from '@unionkeyhq/kit-bg/src/services/ServiceHTTP';
import { MigrateNotificationNames } from '@unionkeyhq/kit-bg/src/services/ServiceMigrate';
import type { MigrateNotificationData } from '@unionkeyhq/kit-bg/src/services/ServiceMigrate';
import qrcodeLogo from '@unionkeyhq/kit/assets/qrcode_logo.png';
