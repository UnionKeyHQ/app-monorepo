...
import type { IDefaultWalletSettingsWithLogo } from '@unionkey/kit-bg/src/dbs/simple/entity/SimpleDbEntityDefaultWalletSettings';
import {
  EAppEventBusNames,
  appEventBus,
  ...
  return (
    ...
    >
      <Image
        w="$80"
        h={341}
        source={require('@unionkey/kit/assets/extension_menu.png')}
      />
    </Stack>
  );
}
