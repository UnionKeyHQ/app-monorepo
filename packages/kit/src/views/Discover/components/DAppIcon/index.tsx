...
import { Box, Icon, Image, NetImage } from '@unionkeyhq/components';
import DAppIconBG from '@unionkeyhq/kit/assets/DAppIcon_bg.png';
import multichainPNG from '@unionkeyhq/kit/assets/dappIcon_multichain.png';
