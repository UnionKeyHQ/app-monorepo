...
import txFailedIcon from '@unionkeyhq/kit/assets/transaction/status/tx_failed.png';
import txOfflineIcon from '@unionkeyhq/kit/assets/transaction/status/tx_offline.png';
