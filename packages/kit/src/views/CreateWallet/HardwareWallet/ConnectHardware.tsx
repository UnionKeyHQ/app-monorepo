...
import ClassicDeviceIcon from '@unionkeyhq/components/img/deviceIcon_classic.png';
        ...
        <Box alignItems="center">
          <Box w="358px" h="220px" mb={-4}>
            <LottieView
              ...
              source={require('@unionkeyhq/kit/assets/animations/connect_by_bluetooth.json')}
              autoPlay
              loop
            />
          </Box>
        ...
        children: platformEnv.isNative ? (
          ...
          <Box alignItems="center" h="full">
            <Box>
              <LottieView
                // eslint-disable-next-line global-require
                source={require('@unionkeyhq/kit/assets/animations/connect_by_usb.json')}
                autoPlay
                loop
              />
            </Box>
