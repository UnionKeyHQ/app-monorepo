...
import { Box, Center, Image, Modal, Typography } from '@unionkeyhq/components';
import ProSetupNewAndImportDevicePng from '@unionkeyhq/kit/assets/wallet/create-or-import-pro-device.png';
import ClassicRestoreDevicePng from '@unionkeyhq/kit/assets/wallet/restore-classic-device.png';
import MiniRestoreDevicePng from '@unionkeyhq/kit/assets/wallet/restore-mini-device.png';
import TouchRestoreDevicePng from '@unionkeyhq/kit/assets/wallet/restore-touch-device.png';
import ClassicSetupNewDevicePng from '@unionkeyhq/kit/assets/wallet/setup-new-classic-device.png';
import MiniSetupNewDevicePng from '@unionkeyhq/kit/assets/wallet/setup-new-mini-device.png';
import TouchSetupNewDevicePng from '@unionkeyhq/kit/assets/wallet/setup-new-touch-device.png';
import { useHelpLink } from '@unionkeyhq/kit/src/hooks';
