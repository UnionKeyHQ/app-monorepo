      ...
      <Box mr="3" position="relative">
        <Box w="10" h="10" borderRadius="full" overflow="hidden">
          <Image
            w="10"
            h="10"
            source={require('@unionkeyhq/kit/assets/staking/eth_logo.png')}
          />
        </Box>
        <Box
          w="5"
  ...
  const topApr = useMemo(() => {
    ...
    return items.kele > items.lido
      ? {
          ...
          logo: require('@unionkeyhq/kit/assets/staking/kele_pool.png'),
        }
      : {
          name: 'Lido • Ethereum',
          value: `${formatAmount(items.lido, 2)}%`,
          logo: require('@unionkeyhq/kit/assets/staking/lido_pool.png'),
        };
