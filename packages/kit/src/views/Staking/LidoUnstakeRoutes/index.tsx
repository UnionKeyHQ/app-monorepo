...
import { Box, Image, Modal, Typography, VStack } from '@unionkeyhq/components';
        ...
        >
          <Box flexDirection="row" alignItems="center">
            <Image
              ...
              h="10"
              mr="3"
              source={require('@unionkeyhq/kit/assets/staking/lido_pool.png')}
            />
        ...
        >
          <Box flexDirection="row" alignItems="center">
            <Image
              ...
              h="10"
              mr="3"
              source={require('@unionkeyhq/kit/assets/logo_black.png')}
            />
            <Box flexDirection="column" justifyContent="space-between">
              <Typography.Body1Strong>UnionKey Swap</Typography.Body1Strong>
              <Typography.Body2 color="text-subdued">
                {intl.formatMessage(
