...
import { T1Data } from '@unionkeyhq/kit/src/utils/hardware/constants/homescreensData';
import { elementToHomescreen } from '@unionkeyhq/kit/src/utils/hardware/homescreens';
...
const GenerateHomescreen: FC = () => {
  ...
  const handleClick = (imageId: string) => {
    ...
    if (element instanceof HTMLImageElement) {
      ...
      const imageData = {
        name: imageId,
        staticPath: `require('@unionkeyhq/kit/assets/hardware/homescreens/t1/${imageId}.png')`,
        hex,
      };
  ...
  const generateAllData = () => {
    ...
    Object.entries(T1Data).forEach(([name]) => {
      ...
      if (element instanceof HTMLImageElement) {
        ...
        const imageData = {
          name,
          staticPath: `require('@unionkeyhq/kit/assets/hardware/homescreens/t1/${name}.png')`,
          hex,
        };
