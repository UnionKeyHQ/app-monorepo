...
import { LottieView, XStack } from '@unionkey/components';
import { swapRefreshInterval } from '@unionkey/shared/types/swap/SwapProvider.constants';
    ...
    >
      ...
      >
        <LottieView
          ...
          source={
            themeVariant === 'light'
              ? require('@unionkey/kit/assets/animations/lottie_unionkey_swap_refresh_light.json')
              : require('@unionkey/kit/assets/animations/lottie_unionkey_swap_refresh_dark.json')
          }
          width={18}
          height={18}
          autoPlay
