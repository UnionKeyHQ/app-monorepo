...
import { Page, SizableText, Stack, YStack } from '@unionkey/components';
        ...
        <YStack p="$5" separator={<Stack h="$10" />}>
          <BackupStep
            ...
            image={{
              sm: {
                ratio: 353 / 224,
                source: require('@unionkey/kit/assets/keytag/keytag_doc_step1_sm.png'),
              },
              base: {
                ratio: 600 / 224,
                source: require('@unionkey/kit/assets/keytag/keytag_doc_step1_base.png'),
              },
            }}
            title={intl.formatMessage({
          ...
          <BackupStep
            ...
            image={{
              sm: {
                ratio: 353 / 224,
                source: require('@unionkey/kit/assets/keytag/keytag_doc_step2_sm.png'),
              },
              base: {
                ratio: 600 / 224,
                source: require('@unionkey/kit/assets/keytag/keytag_doc_step2_base.png'),
              },
            }}
            title={intl.formatMessage({
          ...
          <BackupStep
            ...
            image={{
              sm: {
                ratio: 353 / 224,
                source: require('@unionkey/kit/assets/keytag/keytag_doc_step3_sm.png'),
              },
              base: {
                ratio: 600 / 224,
                source: require('@unionkey/kit/assets/keytag/keytag_doc_step3_base.png'),
              },
            }}
            title={intl.formatMessage({
