...
import { Haptics, ImpactFeedbackStyle } from '@unionkey/components';
...
import { UnionKeyErrorScanQrCodeCancel } from '@unionkey/shared/src/errors';
import {
  EModalRoutes,
...
import {
  EQRCodeHandlerType,
  PARSE_HANDLER_NAMES,
} from '@unionkey/shared/types/qrCode';
