...
const SettingAccountDerivationModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/AccountDerivation'),
);

const SettingAppAutoLockModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/AppAutoLock'),
);

const SettingCurrencyModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/Currency'),
);
const SettingClearAppCacheModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/ClearAppCache'),
);
const SettingListModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/List'),
);
const SettingProtectionModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/Protection'),
);
const SettingSpendUTXOModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/SpendUTXO'),
);
const SettingCustomRPCModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/CustomRPC'),
);
...
const SettingSignatureRecordModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/SignatureRecord'),
);

const FloatingIconModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/FloatingIcon'),
);

const FirmwareUpdateDevSettings = LazyLoadPage(
  () =>
    import('@unionkey/kit/src/views/Setting/pages/FirmwareUpdateDevSettings'),
);

const V4MigrationDevSettings = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/V4MigrationDevSettings'),
);

const PageDevUnitTests = LazyLoadPage(
  () =>
    import(
      '@unionkey/kit/src/views/Setting/pages/DevUnitTests/PageDevUnitTests'
    ),
);

const ExportCustomNetworkConfig = LazyLoadPage(
  () =>
    import('@unionkey/kit/src/views/Setting/pages/ExportCustomNetworkConfig'),
);

const NotificationsSettings = LazyLoadPage(
  () =>
    import(
      '@unionkey/kit/src/views/Setting/pages/Notifications/NotificationsSettings'
    ),
);
...
const ManageAccountActivity = LazyLoadPage(
  () =>
    import(
      '@unionkey/kit/src/views/Setting/pages/Notifications/ManageAccountActivity'
    ),
);

const AlignPrimaryAccountModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/AlignPrimaryAccount'),
);

const CustomTransactionModal = LazyLoadPage(
  () => import('@unionkey/kit/src/views/Setting/pages/CustomTransaction'),
);
