...
import { AppLock } from '@unionkeyhq/kit/src/components/AppLock';
import { useAppSelector } from '@unionkeyhq/kit/src/hooks/redux';
import { updateVersionAndBuildNumber } from '@unionkeyhq/kit/src/store/reducers/settings';
import { setAuthenticationType } from '@unionkeyhq/kit/src/store/reducers/status';
