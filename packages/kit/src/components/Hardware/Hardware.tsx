...
import type { IColorTokens, UseFormReturn } from '@unionkeyhq/components';
import {
  Alert,
  Anchor,
  Button,
  ...
  const requireResource = useCallback(() => {
    switch (deviceType) {
      ...
      case EDeviceType.ClassicPure:
        return import(
          '@unionkeyhq/kit/assets/animations/confirm-on-classic.json'
        );
      case EDeviceType.Mini:
        return import('@unionkeyhq/kit/assets/animations/confirm-on-mini.json');
      case EDeviceType.Touch:
        return import('@unionkeyhq/kit/assets/animations/confirm-on-touch.json');
      case EDeviceType.Pro:
        return import(
          '@unionkeyhq/kit/assets/animations/confirm-on-pro-dark.json'
        );
      default:
...
export function EnterPinOnDevice({
  ...
  const requireResource = useCallback(() => {
    switch (deviceType) {
      ...
      case EDeviceType.ClassicPure:
        return import(
          '@unionkeyhq/kit/assets/animations/enter-pin-on-classic.json'
        );
      case EDeviceType.Mini:
        return import('@unionkeyhq/kit/assets/animations/enter-pin-on-mini.json');
      case EDeviceType.Touch:
        return import(
          '@unionkeyhq/kit/assets/animations/enter-pin-on-touch.json'
        );
      case EDeviceType.Pro:
        return import(
          '@unionkeyhq/kit/assets/animations/enter-pin-on-pro-dark.json'
        );
      default:
        // eslint-disable-next-line @typescript-eslint/no-unused-vars, no-case-declarations
        const checkType = deviceType;
...
export function EnterPassphraseOnDevice({
  ...
  const requireResource = useCallback(() => {
    switch (deviceType) {
      ...
      case EDeviceType.ClassicPure:
        return import(
          '@unionkeyhq/kit/assets/animations/enter-passphrase-on-classic.json'
        );
      case EDeviceType.Mini:
        return import(
          '@unionkeyhq/kit/assets/animations/enter-passphrase-on-mini.json'
        );
      case EDeviceType.Touch:
        return import(
          '@unionkeyhq/kit/assets/animations/enter-passphrase-on-touch.json'
        );
      case EDeviceType.Pro:
        return import(
          '@unionkeyhq/kit/assets/animations/enter-passphrase-on-pro-dark.json'
        );
      default:
        // eslint-disable-next-line @typescript-eslint/no-unused-vars, no-case-declarations
        const checkType = deviceType;
