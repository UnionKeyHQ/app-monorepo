...
import GiftExpandOnDark from '@unionkeyhq/kit/assets/animations/gift-expand-on-dark.json';
import GiftExpandOnLight from '@unionkeyhq/kit/assets/animations/gift-expand-on-light.json';
...
import { useToMyUnionKeyModal } from '@unionkeyhq/kit/src/views/DeviceManagement/hooks/useToMyUnionKeyModal';
