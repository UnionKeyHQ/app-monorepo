...
// @ts-ignore
export class UnionKeyWalletConnectSocketTransport extends SocketTransport {
...
const transports: Record<
  string,
  UnionKeyWalletConnectSocketTransport | undefined
> = {};
...
export function getOrCreateTransport({
  ...
  if (!transport) {
    transport = new UnionKeyWalletConnectSocketTransport({
