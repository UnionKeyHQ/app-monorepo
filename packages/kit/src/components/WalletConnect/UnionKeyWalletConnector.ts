...
import { getOrCreateTransport } from './UnionKeyWalletConnectSocketTransport';
import { WALLET_CONNECT_BRIDGE } from './walletConnectConsts';

import type { UnionKeyWalletConnectSocketTransport } from './UnionKeyWalletConnectSocketTransport';
...
export class UnionKeyWalletConnector extends Connector {
  constructor(
    ...
    let transport: UnionKeyWalletConnectSocketTransport | undefined;
  ...
  get socketTransport(): UnionKeyWalletConnectSocketTransport | undefined {
    // @ts-ignore
    return this._transport as UnionKeyWalletConnectSocketTransport | undefined;
  }
