...
import { Box, Center, Icon, Image, NetImage } from '@unionkeyhq/components';
import CollectionDefaultLogo from '@unionkeyhq/components/img/collection_default_logo.png';
import NFTPlaceholderBG from '@unionkeyhq/components/img/NFT_placeholder_bg.png';
