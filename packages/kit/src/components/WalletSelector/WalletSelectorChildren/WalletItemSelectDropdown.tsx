...
import type { IWallet } from '@unionkeyhq/engine/src/types';
import { WALLET_TYPE_HW } from '@unionkeyhq/engine/src/types/wallet';
import backgroundApiProxy from '@unionkeyhq/kit/src/background/instance/backgroundApiProxy';
import type { IHardwareDeviceStatusMap } from '@unionkeyhq/kit/src/components/NetworkAccountSelector/hooks/useDeviceStatusOfHardwareWallet';
import { ValidationFields } from '@unionkeyhq/kit/src/components/Protected';
import { useAppSelector } from '@unionkeyhq/kit/src/hooks';
import useAppNavigation from '@unionkeyhq/kit/src/hooks/useAppNavigation';
import useLocalAuthenticationModal from '@unionkeyhq/kit/src/hooks/useLocalAuthenticationModal';
import type { RootNavContainerRef } from '@unionkeyhq/kit/src/provider/NavigationProvider';
import {
