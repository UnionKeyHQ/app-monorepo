...
import type { DeviceState } from '@unionkeyhq/kit/src/components/WalletSelector/WalletAvatar';
import {
  WalletAvatarPro,
  useHardwareWalletInfo,
} from '@unionkeyhq/kit/src/components/WalletSelector/WalletAvatar';
import {
  useActiveWalletAccount,
  useNavigationActions,
} from '@unionkeyhq/kit/src/hooks';
import { useWalletName } from '@unionkeyhq/kit/src/hooks/useWalletName';
