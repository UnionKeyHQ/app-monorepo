package so.unionkey.app.wallet.unionkeyLite
...
import so.unionkey.app.wallet.unionkeyLite.nfc.AppleCardType
import so.unionkey.app.wallet.unionkeyLite.nfc.Connection
import so.unionkey.app.wallet.unionkeyLite.nfc.CommandGenerator
import so.unionkey.app.wallet.utils.LogUtil.printLog
import so.unionkey.app.wallet.utils.NfcPermissionUtils

object UnionKeyLiteCard {
    const val TAG = "UnionKeyLiteCard"
