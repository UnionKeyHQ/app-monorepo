package so.unionkey.app.wallet.unionkeyLite.nfc
...
import so.unionkey.app.wallet.keys.KeysNativeProvider
import so.unionkey.app.wallet.nfc.NFCExceptions
import so.unionkey.app.wallet.unionkeyLite.NfcConstant
import so.unionkey.app.wallet.unionkeyLite.entitys.*
import so.unionkey.app.wallet.unionkeyLite.nfc.GPCAPDUGenerator.buildGPCAPDU
import so.unionkey.app.wallet.unionkeyLite.nfc.GPCAPDUGenerator.combCommand
import so.unionkey.app.wallet.utils.HexUtils
import so.unionkey.app.wallet.utils.HexUtils.byteArr2HexStr
import so.unionkey.app.wallet.utils.HexUtils.hexString2Bytes
import so.unionkey.app.wallet.utils.LogUtil.printLog
