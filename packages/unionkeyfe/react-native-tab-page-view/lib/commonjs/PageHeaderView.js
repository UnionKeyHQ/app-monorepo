...
var _SelectedLabel = _interopRequireDefault(require("./SelectedLabel"));
var _PageHeaderCursor = _interopRequireDefault(require("./PageHeaderCursor"));
...
class PageHeaderView extends _react.Component {
  scrollPageIndex = this.props.initialScrollIndex ?? 0;
  scrollPageIndexValue = new _reactNative.Animated.Value(this.scrollPageIndex, {
    useNativeDriver: false
  });
  nextScrollPageIndex = -1;
  shouldHandlerAnimationValue = true;
  itemConfigList = this.props.data.map(_ => ({
    _animtedEnabledValue: new _reactNative.Animated.Value(1),
    _containerRef: /*#__PURE__*/_react.default.createRef()
  }));
  itemContainerStyle = () => ({
    height: '100%',
    flexDirection: 'row',
  ...
  cursor = /*#__PURE__*/_react.default.createRef();
  scrollViewWidth = 0;
  static defaultProps = {
    data: [],
    horizontal: true,
  ...
  _animation = (() => function (key, value) {
    ...
    _reactNative.Animated.timing(key, {
      toValue: value,
      duration: duration,
  ...
  _itemTitleProps = (item, index) => {
    ...
    const enabled = (this === null || this === void 0 || (_this$itemConfigList = this.itemConfigList) === null || _this$itemConfigList === void 0 || (_this$itemConfigList = _this$itemConfigList[index]) === null || _this$itemConfigList === void 0 ? void 0 : _this$itemConfigList._animtedEnabledValue) ?? new _reactNative.Animated.Value(1);
    scale = _reactNative.Animated.add(_reactNative.Animated.multiply(scale, enabled), _reactNative.Animated.multiply(1, _reactNative.Animated.subtract(1, enabled)));
  ...
  _renderTitle = (item, index) => {
    return /*#__PURE__*/_react.default.createElement(_SelectedLabel.default, this._itemTitleProps(item, index));
  };
  ...
  _renderCursor = () => {
    return /*#__PURE__*/_react.default.createElement(_PageHeaderCursor.default, {
      ref: this.cursor,
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: style
    }, /*#__PURE__*/_react.default.createElement(_reactNative.ScrollView, _extends({
...
exports.default = PageHeaderView;
