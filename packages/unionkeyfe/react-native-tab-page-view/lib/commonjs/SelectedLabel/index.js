...
class SelectedLabel extends _react.Component {
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.Animated.Text, _extends({}, rest, {
      style: [style, {
        color
      }]
    }), text);
