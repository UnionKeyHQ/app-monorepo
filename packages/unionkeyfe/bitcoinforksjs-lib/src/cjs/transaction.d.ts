...
export declare class Transaction {
     ...
     */
    hashForCashSignature(inIndex: number, prevOutScript: Uint8Array, inAmount: bigint, hashType: number): Uint8Array;
    /**
     * Hash transaction for signing a specific input for Bitcoin Gold.
     */
    hashForGoldSignature(inIndex: number, prevOutScript: Uint8Array, inAmount: bigint, hashType: number, sigVersion?: boolean): Uint8Array;
