...
import { clearTranslations } from '@unionkeyhq/kit/src/store/reducers/data';
import {
  addBookmark,
  cleanOldState,
  clearHistory,
...
} from '@unionkeyhq/kit/src/store/reducers/discover';
import { getDefaultLocale } from '@unionkeyhq/kit/src/utils/locale';
import { getWebTabs } from '@unionkeyhq/kit/src/views/Discover/Explorer/Controller/useWebTabs';
import type { MatchDAppItemType } from '@unionkeyhq/kit/src/views/Discover/Explorer/explorerUtils';
import type {
  BannerType,
  BookmarkItem,
  CategoryType,
  DAppItemType,
  GroupDappsType,
} from '@unionkeyhq/kit/src/views/Discover/type';
import {
  backgroundClass,
  backgroundMethod,
