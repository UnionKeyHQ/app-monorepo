...
import type { ISimpleSearchHistoryToken } from '@unionkeyhq/engine/src/dbs/simple/entity/SimpleDbEntityMarket';
...
import type {
  ...
  MarketTokenItem,
  MarketTopTabName,
} from '@unionkeyhq/kit/src/store/reducers/market';
import {
...
import type { ServerToken } from '@unionkeyhq/kit/src/store/typings';
