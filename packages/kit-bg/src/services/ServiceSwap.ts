...
import type { ISwftcCoin } from '@unionkeyhq/engine/src/dbs/simple/entity/SimpleDbEntitySwap';
...
import {
  ...
  switchTokens,
} from '@unionkeyhq/kit/src/store/reducers/swap';
import {
  clearTransactions,
  ...
  setWrapperTokens,
  updateTokenList,
} from '@unionkeyhq/kit/src/store/reducers/swapTransactions';
import type { SendConfirmParams } from '@unionkeyhq/kit/src/views/Send/types';
import type {
  FetchQuoteParams,
  FieldType,
  QuoteData,
...
} from '@unionkeyhq/kit/src/views/Swap/typings';
import {
  convertBuildParams,
  formatAmount,
  ...
  stringifyTokens,
  tokenEqual,
} from '@unionkeyhq/kit/src/views/Swap/utils';
import {
  backgroundClass,
  backgroundMethod,
  bindThis,
...
export default class ServiceSwap extends ServiceBase {
  ...
  async setDefaultInputToken() {
    ...
    const USDC = {
      ...
      decimals: 6,
      logoURI:
        'https://common.unionkey.io/token/evm-1/0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48.jpg',
      impl: 'evm',
      chainId: '1',
    } as ServerToken;
