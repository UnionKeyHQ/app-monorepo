...
import {
  getEventHash,
  validateEvent,
} from '@unionkeyhq/core/src/chains/nostr/sdkNostr';
import type { INostrEvent } from '@unionkeyhq/core/src/chains/nostr/types';
import type IVaultNostr from '@unionkeyhq/kit-bg/src/vaults/impls/nostr/Vault';
import {
  backgroundClass,
  backgroundMethod,
