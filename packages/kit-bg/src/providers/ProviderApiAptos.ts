...
import { AptosMessageTypes } from '@unionkeyhq/engine/src/types/message';
import type {
  IEncodedTxAptos,
  SignMessagePayload,
  SignMessageResponse,
} from '@unionkeyhq/engine/src/vaults/impl/apt/types';
import {
...
} from '@unionkeyhq/engine/src/vaults/impl/apt/utils';
import type VaultAptos from '@unionkeyhq/engine/src/vaults/impl/apt/Vault';
import {
  hexlify,
  stripHexPrefix,
