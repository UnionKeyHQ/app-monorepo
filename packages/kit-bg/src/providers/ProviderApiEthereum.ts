...
import type VaultEvm from '@unionkeyhq/engine/src/vaults/impl/evm/Vault';
import type {
  IEncodedTxEvm,
  IUnsignedMessageEvm,
} from '@unionkeyhq/engine/src/vaults/impl/evm/Vault';
...
} from '@unionkeyhq/shared/src/providerApis/ProviderApiEthereum/ProviderApiEthereum.types';
