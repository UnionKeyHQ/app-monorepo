...
import { NetworkId } from '@unionkeyhq/engine/src/vaults/impl/ada/types';
import type AdaVault from '@unionkeyhq/engine/src/vaults/impl/ada/Vault';
import { getActiveWalletAccount } from '@unionkeyhq/kit/src/hooks';
import {
  backgroundClass,
  providerApiMethod,
} from '@unionkeyhq/shared/src/background/backgroundDecorators';
import { IMPL_ADA } from '@unionkeyhq/shared/src/engine/engineConsts';
