...
import { timeout } from '@unionkeyhq/kit/src/utils/helper';
import { scanFromURLAsync } from '@unionkeyhq/kit/src/views/ScanQrcode/scanFromURLAsync';
import {
  backgroundClass,
  providerApiMethod,
...
} from '@unionkeyhq/shared/src/logger/debugLogger';
...
class ProviderApiPrivate extends ProviderApiBase {
  ...
  */
  ...
  getWalletInfo(): IUnionKeyWalletInfo {
