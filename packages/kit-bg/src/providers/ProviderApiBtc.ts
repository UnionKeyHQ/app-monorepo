...
import { getInputsToSignFromPsbt } from '@unionkeyhq/core/src/chains/btc/sdkBtc';
import {
...
import type { IEncodedTx, ITxInputToSign } from '@unionkeyhq/core/src/types';
import {
  backgroundClass,
  providerApiMethod,
...
import {
  ...
  type IToSignInput,
} from '@unionkeyhq/shared/types/ProviderApis/ProviderApiBtc.type';
import type { IPushTxParams } from '@unionkeyhq/shared/types/ProviderApis/ProviderApiSui.type';
