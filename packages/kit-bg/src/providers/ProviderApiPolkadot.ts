...
import polkadotSdk from '@unionkeyhq/engine/src/vaults/impl/dot/sdk/polkadotSdk';
import type {
  InjectedAccount,
  SignerPayloadJSON,
  SignerPayloadRaw,
} from '@unionkeyhq/engine/src/vaults/impl/dot/sdk/polkadotSdkTypes';
import type { IEncodedTxDot } from '@unionkeyhq/engine/src/vaults/impl/dot/types';
import type VaultDot from '@unionkeyhq/engine/src/vaults/impl/dot/Vault';
