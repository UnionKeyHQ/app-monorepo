...
import type { EvmExtraInfo } from '@unionkeyhq/engine/src/types/network';
import type { IEncodedTxCfx } from '@unionkeyhq/engine/src/vaults/impl/cfx/Vault';
import type VaultConflux from '@unionkeyhq/engine/src/vaults/impl/cfx/Vault';
...
import { IMPL_CFX } from '@unionkeyhq/shared/src/engine/engineConsts';
