...
import { ETHMessageTypes } from '@unionkeyhq/engine/src/types/message';
import type { EvmExtraInfo, Network } from '@unionkeyhq/engine/src/types/network';
import type { IUnsignedMessageEvm } from '@unionkeyhq/engine/src/vaults/impl/evm/Vault';
import { IEncodedTxEvm } from '@unionkeyhq/engine/src/vaults/impl/evm/Vault';
import type { IEncodedTxSTC } from '@unionkeyhq/engine/src/vaults/impl/stc/types';
...
import { fixAddressCase } from '@unionkeyhq/shared/src/engine/engineUtils';
...
class ProviderApiStarcoin extends ProviderApiBase {
   ...
   * Open @type {import("@unionkeyhq/kit/src/views/DappModals/Multicall.tsx").default} contract modal
   * Open @type {import("@unionkeyhq/kit/src/views/DappModals/SendConfirm.tsx").default} send modal
   * Open @type {import("@unionkeyhq/kit/src/views/DappModals/Approve.tsx").default} approve modal
   *
   * Example:
  ...
  /** Sign transaction
   * Open @type {import("@unionkeyhq/kit/src/views/DappModals/Signature.tsx").default} modal
   */
  @providerApiMethod()
