...
import type { Emitter } from '@unionkey/shared/src/eventBus/WagmiEventEmitter';
...
import type { IWalletConnectConnectToWalletParams } from '@unionkey/shared/src/walletConnect/types';
import type {
