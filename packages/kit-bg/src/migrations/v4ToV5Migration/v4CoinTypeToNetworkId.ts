import type { INetworkShortCode } from '@unionkeyhq/shared/src/config/networkIds';
...
> = {
  ...
  [COINTYPE_STC]: 'stc--1', // 'logoURI': 'https://uni.unionkey.io/static/chain/stc.png',
  ...
  [COINTYPE_XMR]: 'xmr--0', // 'logoURI': 'https://common.unionkey.io/chain/monero.png'
