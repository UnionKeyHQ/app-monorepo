import type { INetworkShortCode } from '@unionkey/shared/src/config/networkIds';
...
> = {
  ...
  [COINTYPE_STC]: 'stc--1', // 'logoURI': 'https://uni.unionkey-asset.com/static/chain/stc.png',
  ...
  [COINTYPE_XMR]: 'xmr--0', // 'logoURI': 'https://common.unionkey-asset.com/chain/monero.png'
