...
import type { IEncodedTxAlgo } from '@unionkeyhq/core/src/chains/algo/types';
...
import type { IEncodedTxCosmos } from '@unionkeyhq/core/src/chains/cosmos/types';
import type { IEncodedTxDnx } from '@unionkeyhq/core/src/chains/dnx/types';
...
import type { IEncodedTxNear } from '@unionkeyhq/core/src/chains/near/types';
import type { IEncodedTxNexa } from '@unionkeyhq/core/src/chains/nexa/types';
import type { IEncodedTxNostr } from '@unionkeyhq/core/src/chains/nostr/types';
import type { IEncodedTxSol } from '@unionkeyhq/core/src/chains/sol/types';
...
import type { IEmojiTypes } from '@unionkeyhq/shared/src/utils/emojiUtils';
import type { IEncodedTxLightning } from '@unionkeyhq/shared/types/lightning';
