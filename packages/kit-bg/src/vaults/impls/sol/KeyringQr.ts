...
import { OffchainMessage } from '@unionkeyhq/core/src/chains/sol/sdkSol/OffchainMessage';
import { parseToNativeTx } from '@unionkeyhq/core/src/chains/sol/sdkSol/parse';
import { verifySolSignedTxMatched } from '@unionkeyhq/core/src/chains/sol/sdkSol/verify';
import {
  type IEncodedTxSol,
  type INativeTxSol,
...
import { EAirGapDataTypeSol, getAirGapSdk } from '@unionkeyhq/qr-wallet-sdk';
import {
...
import { EMessageTypesSolana } from '@unionkeyhq/shared/types/message';
