...
import NestedTabView from '@unionkeyhq/app/src/views/NestedTabView/NestedTabView';
import type {
  OnPageChangeEvent,
  TabProps,
} from '@unionkeyhq/app/src/views/NestedTabView/types';
import { useThemeValue } from '@unionkeyhq/components';
