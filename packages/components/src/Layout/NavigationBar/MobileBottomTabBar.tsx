...
import {
  ...
  bottomTabBarRoutes,
  swapAndMarketRoutes,
} from '@unionkeyhq/kit/src/routes/Root/Main/Tab/routes/tabRoutes.base';
import type { TabRoutes } from '@unionkeyhq/kit/src/routes/routesEnum';
import { PortalContainer } from '@unionkeyhq/kit/src/views/Overlay/RootPortal';
      ...
      routes.map((route, index) => {
        ...
        const onPress = () => {
          if (inlineMode) {
            ...
            //   const { appSelector } =
            //     require('@unionkeyhq/kit/src/store') as typeof import('@unionkeyhq/kit/src/store');
