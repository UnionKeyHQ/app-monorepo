...
} from '@unionkey/shared/src/consts/deeplinkConsts';
...
const APP_NAME = 'UnionKey Wallet';
app.name = APP_NAME;
      ...
      submenu: [
        {
          ...
          click: async () => {
            await shell.openExternal('https://unionkey.io/school.html');
          },
        },
        { type: 'separator' },
        {
          ...
          click: async () => {
            await shell.openExternal('https://unionkey.io');
          },
        },
        {
          label: 'Github',
          click: async () => {
            await shell.openExternal(
              'https://github.com/UnionKeyHQ/app-monorepo',
            );
          },
        },
        {
          label: 'X',
          click: async () => {
            await shell.openExternal('https://x.com/UnionKeyHQ');
          },
        },
      ],
    },
...
const src = isDev
  ...
  //browserWindow.webContents.openDevTools({ mode: 'detach' });//ZYF
  ...
  app.on('login', (event, webContents, request, authInfo, callback) => {
    event.preventDefault();
    callback('unionkey', 'juDUIpz3lVnubZ2aHOkwBB6SJotYynyb');
  });
  ...
  session.defaultSession.webRequest.onBeforeSendHeaders(
    ...
    (details, callback) => {
      ...
      if (
        ...
        details.requestHeaders.Origin = 'https://jssdk.unionkey.so';
...
// Closing the cause context: https://unionkey.atlassian.net/browse/OK-8096
