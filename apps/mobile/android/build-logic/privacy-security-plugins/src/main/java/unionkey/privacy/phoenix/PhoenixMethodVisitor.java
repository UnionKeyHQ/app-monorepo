package unionkey.privacy.phoenix;
...
public class PhoenixMethodVisitor extends MethodVisitor implements Opcodes {
    ...
    public void visitMethodInsn(int opcode, String owner, String name, String descriptor, boolean isInterface) {
        ...
        if (opcode == INVOKESPECIAL &&
            ...
            mv.visitFieldInsn(GETSTATIC, "so/unionkey/app/wallet/BuildConfig", "APPLICATION_ID", "Ljava/lang/String;");
            ...
            mv.visitLdcInsn("so.unionkey.app.wallet.MainActivity");
            mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "equals", "(Ljava/lang/Object;)Z", false);
