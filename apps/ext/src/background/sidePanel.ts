  ...
  chrome.runtime.onConnect.addListener((port) => {
    if (port.name === SIDE_PANEL_PORT_NAME) {
      ...
      const closeSidePanel = () => {
        ...
        const backgroundApiProxy: typeof import('@unionkey/kit/src/background/instance/backgroundApiProxy').default =
          // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
          require('@unionkey/kit/src/background/instance/backgroundApiProxy').default;
        if (dappRejectId) {
