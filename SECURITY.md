üôè Please report bug directly to dev@unionkey.so or just shoot it straight to our official page on [BugRap](https://bugrap.io/bounties/UnionKey), where our pros got it covered.
...
* The responsibility of the researcher ‚Ä?did the researcher take destructive action or otherwise harm the functioning of our systems.
* The role of the researcher ‚Ä?was the researcher the first person to discover the bug, or is the bug based on some public information.
